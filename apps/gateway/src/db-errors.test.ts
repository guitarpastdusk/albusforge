...
describe("isDatabaseUnavailable", () => {
  it.each([
    ...
    ["deadlock victim", withCode("deadlock detected", "40P01")],
    ["serialization retry", withCode("could not serialize access", "40001")],
    ["lock timeout", withCode("lock not available", "55P03")],
