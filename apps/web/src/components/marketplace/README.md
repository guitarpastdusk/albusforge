...
- `ListingCard` — pastel header with the category pill and name, description (with its price), author and clone count, and "Open build →" (the listing page; "Clone build" lives there, see `lib/clone-ask.ts`).
