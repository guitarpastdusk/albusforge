...
- `onState` optionally reports connecting/open/reconnecting/paused/unavailable; `reconnectKey` lets a retry replace the source. Callbacks from a closed/replaced source are ignored. Existing build chat callers need no changes.
