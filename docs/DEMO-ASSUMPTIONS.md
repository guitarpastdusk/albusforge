...
nothing is keyed on an environment flag.
...
| Device-ready card "View a sample enclosure in 3D →" | Staged: the checked-in fixture GLB, labelled "Sample enclosure · not this build's" | `src/components/enclosure/fixture.ts` (`ENCLOSURE_SAMPLE`) | `GET /v1/builds/:id/body` (ASK-TO-ENCLOSURE §6) |
