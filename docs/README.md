...
| [TELEMETRY-INGEST.md](TELEMETRY-INGEST.md) | M6a gateway ingestion, wire/storage semantics, simulator runbook, production gates and dashboard/intelligence follow-ups. |
