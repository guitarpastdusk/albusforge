...
- **Sessions** are opaque random tokens, stored hashed in Postgres with an expiry, sent as an `httpOnly`, `Secure`, `SameSite=Lax`, **host-only** cookie ([0007](0007-portal-routing.md)).
