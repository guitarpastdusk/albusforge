...
Scope today is the **portal-facing surface** — the routes the six portal screens call. Part Definition, Spec, BuildPlan, snapshots and events ([`docs/ARCHITECTURE.md`](../../docs/ARCHITECTURE.md) §3) join in M1.
